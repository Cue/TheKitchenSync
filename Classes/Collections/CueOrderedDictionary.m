...
- (void)removeFront
{
    ...
    [dictionary removeObjectForKey:array[0]];
...
- (void)removeBack
{
    ...
    [dictionary removeObjectForKey:[array lastObject]];
...
- (BOOL)isEqual:(CueOrderedDictionary *)object
{
    ...
    return [dictionary isEqual:object->dictionary] && [array isEqual:object->array];
}
